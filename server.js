...
Handlebars.registerPartial('layout', fs.readFileSync('views/layout.html').toStri\
ng());
...
var staticFiles = st({ path: __dirname + '/static', url: '/static', passthrough:\
true })
...
router.get('/:id', function(id){
   var self = this;
   var pagesRequest = request(wiki.api + '/pages/?region__slug=seattle&tags=' + i\
       d + '&format=json');
...
return Handlebars.compile(fs.readFileSync('./views/' + file + '.html').toStrin\
g());
